...
exports = module.exports = function(options){
  ...
  return function multipart(req, res, next) {
    ...
    limit(req, res, function(err){
      ...
      var formidableOpts = formidable.IncomingForm.defaultOpts;
      formidableOpts.useInMemoryMinSize = 5242880; //5mb
      var form = new formidable.IncomingForm(formidableOpts)
        , data = {}
        , files = {}
        , done;
